...
<template>
    ...
    <UserLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4">
            <!-- <div class="relative flex-1 rounded-xl border border-sidebar-border/70 p-20 dark:border-sidebar-border"></div> -->
            <div class="grid auto-rows-min gap-4 md:grid-cols-4">
                <div class="overflow relative aspect-video rounded-xl border border-sidebar-border/70 p-4 dark:border-sidebar-border">
                    <p class="mb-4 font-bold text-red-500">Pending</p>
                ...
                <div class="relative aspect-video rounded-xl border border-sidebar-border/70 p-4 dark:border-sidebar-border">
                    <p class="mb-4 font-bold text-blue-500">In Progress</p>
                ...
                <div class="relative aspect-video rounded-xl border border-sidebar-border/70 p-4 dark:border-sidebar-border">
                    <p class="mb-4 font-bold text-green-500">Completed</p>
